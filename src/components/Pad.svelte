...
<style>
  ...
  #top {
    ...
    right: 0;
    height: 30px;
    background-color: rgb(250, 207, 120);
    z-index: 4;
    box-shadow: 0px 2px 0px 0px rgb(248, 248, 237);
  }
  #paper {
    width: 450px;
    height: 500px;
    ...
    box-shadow: 0px 0px 5px 0px #888, 1px 1px 0px rgb(248, 248, 237),
      2px 2px 0px rgb(248, 248, 237), 3px 3px 0 rgb(248, 248, 237),
